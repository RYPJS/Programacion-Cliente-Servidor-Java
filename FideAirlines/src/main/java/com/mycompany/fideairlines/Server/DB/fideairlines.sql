...
CREATE TABLE `chat` (
  ...
  CONSTRAINT `chat_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cliente` (
  ...
  CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`id`) REFERENCES `person` (`id`),
  CONSTRAINT `cliente_ibfk_2` FOREIGN KEY (`vuelo_id`) REFERENCES `vuelo` (`numeroVuelo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleado` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`id`) REFERENCES `person` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vuelo` (
  ...
  `clase` enum('Economy','Business','First') DEFAULT NULL,
  ...
  CONSTRAINT `vuelo_ibfk_1` FOREIGN KEY (`destino_id`) REFERENCES `destino` (`id`),
  CONSTRAINT `vuelo_ibfk_2` FOREIGN KEY (`aerolinea_id`) REFERENCES `aerolinea` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-04 21:51:16
